...
import com.woxich.locatalert.model.AlarmsRepository
...
const val TAG1 = "GeoFenceBroadcastReceiver"
...
class GeoFenceBroadcastReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent?) {
        ...
        geofenceTransition == Geofence.GEOFENCE_TRANSITION_EXIT) {
            ...
            Log.i(TAG1, "Broadcast received successfully")
        } else {
            // Log the error.
            Log.e(TAG1, "Error while processing geo fence broadcast")
        }
    }
