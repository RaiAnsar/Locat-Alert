...
import com.woxich.locatalert.ChatRoomChangedEvent
import com.woxich.locatalert.ChatStartedEvent
                        ...
                        for(otherUserUid in otherUsersIds) {
                            userRepository.getUserById(otherUserUid).addOnCompleteListener { userResult ->
                                ...
                                if(userResult.isSuccessful && userResult.result != null) {
                                    ...
                                    otherUsers[otherUsersIds.indexOf(otherUserUid)] = userResult.result!!.toObject(
                                        User::class.java)!!
